...
if ( is_plugin_inactive( 'cuberaksi-xendit/klaviyo/klaviyo.php' ) ) {
	...
	if ( ! defined( 'KLAVIYO_URL' ) ) {
		...
		define( 'KLAVIYO_URL', CUBERAKSI_XENDIT_BASE_URL . 'klaviyo/' );
	}
	if ( ! defined( 'KLAVIYO_PATH' ) ) {
		define( 'KLAVIYO_PATH', CUBERAKSI_XENDIT_BASE_DIR . 'klaviyo/' );
	}
	...
	if ( ! class_exists( 'WPKlaviyo' ) ) {
		include_once KLAVIYO_PATH . 'includes/class-wpklaviyo.php';
	}
