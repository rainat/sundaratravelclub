...
return apply_filters(
    ...
    array(
        'channel_name' => array(
            ...
            'placeholder' => 'Bank Transfer - Mandiri',
        ),
        'payment_description' => array(
            ...
            'placeholder' => 'Bayar pesanan dengan transfer bank Mandiri dengan virtual account melalui Xendit',
        )
    )
);
