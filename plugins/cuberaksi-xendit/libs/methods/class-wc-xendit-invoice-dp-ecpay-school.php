...
class WC_Xendit_DP_ECPay_School extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 50000;
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'DP_ECPAY_SCHOOL';
        $this->default_title = 'ECPay School';
        ...
        $this->method_title = __('Xendit ECPay School', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dp-ecpay-school-settings.php');
    }
