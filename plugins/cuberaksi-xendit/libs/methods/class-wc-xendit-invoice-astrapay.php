...
class WC_Xendit_Astrapay extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'astrapay';
        $this->default_title = 'AstraPay';
        ...
        $this->method_title = __('Xendit AstraPay', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-astrapay-settings.php');
    }
