...
class WC_Xendit_Akulaku extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 25000000;
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'akulaku';
        $this->default_title = 'Akulaku';
        ...
        $this->method_title = __('Xendit Akulaku', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-akulaku-settings.php');
    }
