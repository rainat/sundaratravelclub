...
class WC_Xendit_DP_ECPay_Loan extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'DP_ECPAY_LOAN';
        $this->default_title = 'ECPay Loan';
        ...
        $this->method_title = __('Xendit ECPay Loan', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dp-ecpay-loan-settings.php');
    }
