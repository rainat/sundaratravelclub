...
class WC_Xendit_DD_BPI extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'DD_BPI';
        $this->default_title = 'Direct Debit BPI';
        ...
        $this->method_title = __('Xendit Direct Debit BPI', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-dd-bpi-settings.php');
    }
