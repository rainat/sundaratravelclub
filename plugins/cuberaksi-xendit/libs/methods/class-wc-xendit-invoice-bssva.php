...
class WC_Xendit_BSSVA extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'sahabat_sampoerna';
        ...
        $this->method_title = __('Xendit BSS VA', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-bssva-settings.php');
    }
