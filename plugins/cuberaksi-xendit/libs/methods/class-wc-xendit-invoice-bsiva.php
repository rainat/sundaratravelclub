...
class WC_Xendit_BSIVA extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_title = __('Xendit BSI VA', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-bsiva-settings.php');
    }
