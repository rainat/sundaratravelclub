...
class WC_Xendit_DP_Palawan extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 20000;
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'DP_PALAWAN';
        $this->default_title = 'Palawan Express Pera Padala';
        ...
        $this->method_title = __('Xendit Palawan Express Pera Padala', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dp-palawan-settings.php');
    }
