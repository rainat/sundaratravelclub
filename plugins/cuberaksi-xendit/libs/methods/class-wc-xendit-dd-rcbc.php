...
class WC_Xendit_DD_RCBC extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'DD_RCBC';
        $this->default_title = 'Direct Debit RCBC';
        ...
        $this->method_title = __('Xendit Direct Debit RCBC', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-dd-rcbc-settings.php');
    }
