...
class WC_Xendit_QRIS extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_title = __('Xendit QRIS', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-qris-settings.php');
    }
