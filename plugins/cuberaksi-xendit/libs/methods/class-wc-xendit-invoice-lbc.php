...
class WC_Xendit_LBC extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'LBC';
        $this->default_title = 'LBC';
        ...
        $this->method_title = __('Xendit LBC', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-lbc-settings.php');
    }
