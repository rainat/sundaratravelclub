...
class WC_Xendit_DD_UBP extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 9999999999;
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'DD_UBP';
        $this->default_title = 'Direct Debit UBP';
        ...
        $this->method_title = __('Xendit Direct Debit UBP', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-dd-ubp-settings.php');
    }
