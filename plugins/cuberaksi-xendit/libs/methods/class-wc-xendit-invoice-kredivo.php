...
class WC_Xendit_Kredivo extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 30000000;
    ...
    public function __construct()
    {
        ...
        $this->method_title = __('Xendit Kredivo', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-kredivo-settings.php');
    }
