...
class WC_Xendit_Atome extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 6000000;
    const DEFAULT_MINIMUM_AMOUNT = 50000;

    public function __construct()
    {
        parent::__construct();

        $this->id           = 'xendit_atome';
        ...
        $this->method_code = 'Atome';
        $this->default_title = 'Atome';
        ...
        $this->method_title = __('Xendit Atome', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-atome-settings.php');
    }
