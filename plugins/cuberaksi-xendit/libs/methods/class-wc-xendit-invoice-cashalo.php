...
class WC_Xendit_Cashalo extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 8000;
    const DEFAULT_MINIMUM_AMOUNT = 1500;

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_cashalo';
        ...
        $this->method_code = 'CASHALO';
        $this->default_title = 'Cashalo';
        ...
        $this->method_title = __('Xendit Cashalo', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-cashalo-settings.php');
    }
