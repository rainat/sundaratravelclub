...
{
    const DEFAULT_MAXIMUM_AMOUNT = 2500000;
    ...
    public function __construct()
    {
        ...
        $this->default_title = sprintf(esc_html(__('Pay at %1$s', 'woocommerce-xendit')), 'Alfamart Group');
        ...
        $this->method_title = __('Xendit Alfamart', 'woocommerce-xendit');
