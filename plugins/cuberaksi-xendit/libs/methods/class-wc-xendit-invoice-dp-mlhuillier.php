...
class WC_Xendit_DP_Mlhuillier extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 200000;
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'DP_MLHUILLIER';
        $this->default_title = 'Mlhuillier';
        ...
        $this->method_title = __('Xendit Mlhuillier', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dp-mlhuillier-settings.php');
    }
