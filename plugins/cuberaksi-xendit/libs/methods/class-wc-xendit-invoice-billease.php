...
class WC_Xendit_Billease extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 150000;
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'BILLEASE';
        $this->default_title = 'BillEase';
        ...
        $this->method_title = __('Xendit BillEase', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-billease-settings.php');
    }
