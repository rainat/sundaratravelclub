...
class WC_Xendit_Paymaya extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'PAYMAYA';
        $this->default_title = 'PayMaya';
        ...
        $this->method_title = __('Xendit PayMaya', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-paymaya-settings.php');
    }
