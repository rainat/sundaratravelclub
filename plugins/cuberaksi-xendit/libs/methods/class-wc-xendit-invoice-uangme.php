...
class WC_Xendit_Uangme extends WC_Xendit_Invoice
{
    ...
    public function __construct()
    {
        ...
        $this->method_code = 'uangme';
        $this->default_title = 'UangMe';
        ...
        $this->method_title = __('Xendit Uangme', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-uangme-settings.php');
    }
