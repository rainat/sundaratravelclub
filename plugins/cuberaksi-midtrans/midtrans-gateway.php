<?php
/*
Plugin Name: Cuberaksi - Midtrans - WooCommerce Payment Gateway
Plugin URI: http://cuberaksi.com
Description: Accept all payment directly on your WooCommerce site in a seamless and secure checkout environment with <a  target="_blank" href="https://midtrans.com/">Midtrans</a>, customize amelia booking 
Version: 0.0.1
Author: Forked Midtrans - Custom by Cuberaksi
 ...
 * Add Login Google functionality
 */
...
if (!defined('CUBERAKSI_MIDTRANS_BASE_NAME')) define('CUBERAKSI_MIDTRANS_BASE_NAME', plugin_basename(__DIR__));
if (!defined('CUBERAKSI_MIDTRANS_BASE_DIR')) define('CUBERAKSI_MIDTRANS_BASE_DIR', plugin_dir_path(__FILE__));
if (!defined('CUBERAKSI_MIDTRANS_BASE_URL')) define('CUBERAKSI_MIDTRANS_BASE_URL', plugin_dir_url(__FILE__));

class CUBERAKSI_MIDTRANS_
{

  function Cuberaksi_Midtrans_Init()
  {
...
$CMI = new CUBERAKSI_MIDTRANS_();


// Make sure we don't expose any info if called directly
add_action('plugins_loaded', [$CMI, 'Cuberaksi_Midtrans_Init'], 0);
...
require "google/login-with-google.php";
require "woo/custom.php";
