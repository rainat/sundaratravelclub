...
<form class="cart" method="post" enctype='multipart/form-data'>
	...
	<div class="flex flex-col gap-2" id="wrap-login-book">
		...
		<button comingsoon="<?php if ($comingsoon) echo '1';
							else echo '0'; ?>" id="submit-bookable" type="submit" class="<?php echo esc_attr($add_to_cart_classes); ?>"> <?php echo $caption_button; //echo esc_html( $product->single_add_to_cart_text() );  
																																			?></button>
		<? /* aikhacode enable sementara */ ?>
