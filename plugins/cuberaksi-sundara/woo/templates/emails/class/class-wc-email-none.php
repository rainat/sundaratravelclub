...
if (!class_exists('Cuber_WC_Email_Customer_On_Hold_Order', false)) {
    /**
     ...
     * @extends     WC_Email
     */
    class Cuber_WC_Email_Customer_On_Hold_Order extends WC_Email
    {
        /**
         * Constructor.
         */
...
return new Cuber_WC_Email_Customer_On_Hold_Order();
