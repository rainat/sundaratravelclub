...
<div class="booking-details__wrapper">
	...
	<img src="<?php echo $image[0];?>" style="width:100%;max-width:1024px;max-height:640px;"/>
	<table class="booking-details" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; background: white" border="0">
