...
<?php foreach (WC()->cart->get_coupons() as $code => $coupon) { ?>
 ...
 -->
	...
	<div class="flex flex-row justify-content-end gap-8 mb-2">
		<div class="text-right text-lg text-black w-5"><?php esc_html_e('Grand Total', 'woocommerce'); ?></div>
		<div class="text-right  w-2 text-2xl " style="color:#A87C51"><?php wc_cart_totals_order_total_html(); ?></div>

	</div>
	<div class="w-full text-right text-sm text-gray-900 mb-4">Include taxes and fees</div>
