...
class PostType
{
	...
	function register_post_type()
	{
		...
		$labels = [
			"name" => esc_html__("Product Summary", "cuberaksi-sundara"),
			"singular_name" => esc_html__("Product Summary", "cuberaksi-sundara"),
			// "add_new " => esc_html__("Add New Product Features", "cuberaksi-xendit"),
			// "add_new_item" => esc_html__("Add New Product Feature", "cuberaksi-xendit"),
			// "edit_item" => esc_html__("Edit Product Feature", "cuberaksi-xendit"),
			// "new_item" => esc_html__("Add New Product Feature", "cuberaksi-xendit"),
		...
		$args = [
			"label" => esc_html__("Product Summary", "cuberaksi-sundara"),
			"labels" => $labels,
			"description" => "Product summary Extension Cuberaksi Woocommerce",
			"public" => true,
			"publicly_queryable" => true,
			"show_ui" => true,
			"show_in_rest" => false,
		...
		register_post_type("product_summary", $args);
	}
}
