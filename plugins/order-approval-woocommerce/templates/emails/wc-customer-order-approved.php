...
<a style='background: #bbcdf9;color:#ffffff!important;padding: 12px!important;' href='<?php echo $pay_now_url;?>'> <?php  printf( __( 'Pay now', 'order-approval-woocommerce' ) ); ?></a></p>
<?php 
/**
