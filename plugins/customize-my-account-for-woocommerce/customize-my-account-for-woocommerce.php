...
/*
    ...
    Description: Customize My account page Endpoints. Manage Existing Endpoints as well as add new links. Easily hide/show existing Endpoints
    Version: 1.8.8
    Author: SysBasics
...
if ( is_plugin_active( 'customize-my-account-for-woocommerce-pro/customize-my-account-for-woocommerce-pro.php' ) ) {


    function wcva_installation_notice() {
       echo '<div class="updated" style="padding:15px; position:relative;">'.esc_html__('You have pro version active. Disable the free version of Customize My Account for WooCommerce Plugin to prevent conflict.','customize-my-account-for-woocommerce').'</div>';
    }
...
include dirname( __FILE__ ) . '/include/wcmamtx_frontend_customizer.php';
