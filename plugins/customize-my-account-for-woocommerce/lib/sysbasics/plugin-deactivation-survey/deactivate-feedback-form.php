...
add_action('admin_enqueue_scripts', function() {
	...
	wp_localize_script('sysbasics-deactivate-feedback-form', 'sysbasics_deactivate_feedback_form_strings', array(
		...
		'theme_name'			    => __('Theme Name', 'sysbasics'),
		'theme_fix'                 => __('Visit settings tab and set yes for "Disable navigation template override" option,that will fix the issue most probably', 'sysbasics'),
		'theme'			            => $theme->name,
		'elementor_mode'            => wcmamtx_elementor_mode,
		...
		'contact_support'					=> __('Contact Support', 'sysbasics')
	));
